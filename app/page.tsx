    ...
    <>
      ...
      <div className="container" style={{ maxWidth: "820px" }}>
        ...
        <div style={{ textAlign: "center", padding: "60px 0 40px" }}>
          ...
          >
            Crie planos de treino completos com periodização, divisões e
            exercícios. Cada aluno recebe um link personalizado para acessar o
            próprio treino.
          </p>
          <div
            style={{
          ...
          {[
            {
              ...
              desc: "Monte divisões PPL, ABC, Full Body e mais. Adicione exercícios com tipo, descanso e notas.",
            },
            {
              icon: "📈",
              title: "Periodização completa",
              desc: "Configure semanas com volume, intensidade, séries e reps. Cluster sets inclusos.",
            },
            {
              icon: "🔗",
              title: "Link por aluno",
              desc: "Cada aluno acessa o treino pelo link /seu-nome/aluno — sem login, sem app.",
            },
            {
              icon: "🎨",
              title: "Tema personalizado",
              desc: "Adapte as cores do painel e da view do aluno para a identidade da sua marca. (Pro)",
            },
          ].map((f) => (
            <div
              key={f.title}
